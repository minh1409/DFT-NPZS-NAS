from Benchmark.Resnetlike import _get_right_parentheses_index_, create_netblock_list_from_str
from . import basicblocks 
from .utils import smart_round
import torch.nn as nn
import uuid

class PlainNetSuperBlockClass(basicblocks.PlainNetBasicBlockClass):
    def __init__(self, representative_params, in_channels=None, out_channels=None, stride=None, sub_layers=None, no_create=False, **kwargs):
        super(PlainNetSuperBlockClass, self).__init__(representative_params, **kwargs)
    ...
    def set_in_channels(self, c):
        ...
        if len(self.block_list) >= 2 and \
                (isinstance(self.block_list[0], basicblocks.ConvKX) or isinstance(self.block_list[0], basicblocks.ConvDW)) and \
                isinstance(self.block_list[1], basicblocks.BN):
...
class SuperConvKXBNRELU(PlainNetSuperBlockClass):
    def __init__(self, representative_params, in_channels=None, out_channels=None, stride=None, sub_layers=None, kernel_size=None,
                 no_create=False, no_reslink=False, no_BN=False, use_se = False, **kwargs):
        super(SuperConvKXBNRELU, self).__init__(representative_params, **kwargs)
        ...
        self.block_list = create_netblock_list_from_str(representative_params, full_str, no_create=no_create,
...
class SuperConvK1BNRELU(SuperConvKXBNRELU):
    def __init__(self, representative_params,in_channels=None, out_channels=None, stride=None, sub_layers=None, no_create=False, **kwargs):
        super(SuperConvK1BNRELU, self).__init__(representative_params, in_channels=in_channels, out_channels=out_channels, stride=stride,
...
class SuperConvK3BNRELU(SuperConvKXBNRELU):
    def __init__(self, representative_params, in_channels=None, out_channels=None, stride=None, sub_layers=None, no_create=False, **kwargs):
        super(SuperConvK3BNRELU, self).__init__(representative_params, in_channels=in_channels, out_channels=out_channels, stride=stride,
                                           sub_layers=sub_layers,
                                           kernel_size=3,
                                           no_create=no_create, **kwargs)
...
class SuperConvK5BNRELU(SuperConvKXBNRELU):
    def __init__(self, representative_params,  in_channels=None, out_channels=None, stride=None, sub_layers=None, no_create=False, **kwargs):
        super(SuperConvK5BNRELU, self).__init__(representative_params, in_channels=in_channels, out_channels=out_channels, stride=stride,
                                           sub_layers=sub_layers,
                                           kernel_size=5,
                                           no_create=no_create, **kwargs)
...
class SuperConvK7BNRELU(SuperConvKXBNRELU):
    def __init__(self, representative_params, in_channels=None, out_channels=None, stride=None, sub_layers=None, no_create=False, **kwargs):
        super(SuperConvK7BNRELU, self).__init__(representative_params, in_channels=in_channels, out_channels=out_channels, stride=stride,
                                           sub_layers=sub_layers,
                                           kernel_size=7,
                                           no_create=no_create, **kwargs)
