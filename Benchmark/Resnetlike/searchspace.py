import itertools
from .superres import SuperResK1K3K1, SuperResK1K5K1, SuperResK1K7K1, SuperResK3K3, SuperResK5K5, SuperResK7K7
...
__block_type_round_channels_base_dict__ = {
    ...
    SuperResK5K5: 8,
    SuperResK7K7: 8,
    SuperResK1K3K1: 8, SuperResK1K5K1: 8, SuperResK1K7K1: 8,
}
        ...
        for student_block_type_list in seach_space_block_type_list_list:
            ...
            for student_block_type in student_block_type_list:
                for student_out_channels, student_sublayers, student_bottleneck_channels in itertools.product(
                    ...
                    student_out_channels = smart_round(student_out_channels, channel_round_base)
                    student_bottleneck_channels = smart_round(student_bottleneck_channels,
                                                                           channel_round_base)
