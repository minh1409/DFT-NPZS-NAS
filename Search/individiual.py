...
EVALUATON_DICT = {}
def objective_function(measurer, representative_params, individual, max_model_size, max_layers):
...
def evaluate_population(measurer, representative_params, population, max_model_size, max_layers):
    for individual in population:
        if individual.objective_values == None:
            individual.objective_values = objective_function(measurer, representative_params, individual, max_model_size, max_layers)
    return population

def evaluate_paretos(measurer, representative_params, paretos, max_model_size, max_layers):
